...
const file_agentassist_proto_rawDesc = "" +
	...
	"\x11embedded_resource\x18\x05 \x01(\v2\".agentassistproto.EmbeddedResourceR\x10embeddedResource\"y\n" +
	...
	"\tMetaEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x012\xc5\x01\n" +
	"\x0eSrvAgentAssist\x12Z\n" +
	"\vAskQuestion\x12$.agentassistproto.AskQuestionRequest\x1a%.agentassistproto.AskQuestionResponse\x12W\n" +
	"\n" +
	"TaskFinish\x12#.agentassistproto.TaskFinishRequest\x1a$.agentassistproto.TaskFinishResponseB\xaf\x01\n" +
	"\x14com.agentassistprotoB\x10AgentassistProtoP\x01Z%github.com/yangjuncode/agentassistant\xa2\x02\x03AXX\xaa\x02\x10Agentassistproto\xca\x02\x10Agentassistproto\xe2\x02\x1cAgentassistproto\\GPBMetadata\xea\x02\x10Agentassistprotob\x06proto3"
...
var file_agentassist_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_agentassist_proto_goTypes = []any{
	...
	(*McpAskQuestionRequest)(nil), // 5: agentassistproto.McpAskQuestionRequest
	(*AskQuestionRequest)(nil),    // 6: agentassistproto.AskQuestionRequest
	(*AskQuestionResponse)(nil),   // 7: agentassistproto.AskQuestionResponse
	(*McpTaskFinishRequest)(nil),  // 8: agentassistproto.McpTaskFinishRequest
	(*TaskFinishRequest)(nil),     // 9: agentassistproto.TaskFinishRequest
	(*TaskFinishResponse)(nil),    // 10: agentassistproto.TaskFinishResponse
	nil,                           // 11: agentassistproto.AskQuestionResponse.MetaEntry
	nil,                           // 12: agentassistproto.TaskFinishResponse.MetaEntry
}
var file_agentassist_proto_depIdxs = []int32{
	...
	5,  // 4: agentassistproto.AskQuestionRequest.Request:type_name -> agentassistproto.McpAskQuestionRequest
	11, // 5: agentassistproto.AskQuestionResponse.Meta:type_name -> agentassistproto.AskQuestionResponse.MetaEntry
	4,  // 6: agentassistproto.AskQuestionResponse.contents:type_name -> agentassistproto.McpResultContent
	8,  // 7: agentassistproto.TaskFinishRequest.Request:type_name -> agentassistproto.McpTaskFinishRequest
	12, // 8: agentassistproto.TaskFinishResponse.Meta:type_name -> agentassistproto.TaskFinishResponse.MetaEntry
	4,  // 9: agentassistproto.TaskFinishResponse.contents:type_name -> agentassistproto.McpResultContent
	6,  // 10: agentassistproto.SrvAgentAssist.AskQuestion:input_type -> agentassistproto.AskQuestionRequest
	9,  // 11: agentassistproto.SrvAgentAssist.TaskFinish:input_type -> agentassistproto.TaskFinishRequest
	7,  // 12: agentassistproto.SrvAgentAssist.AskQuestion:output_type -> agentassistproto.AskQuestionResponse
	10, // 13: agentassistproto.SrvAgentAssist.TaskFinish:output_type -> agentassistproto.TaskFinishResponse
