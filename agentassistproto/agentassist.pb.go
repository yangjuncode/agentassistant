...
func (ForwardTarget_Mode) EnumDescriptor() ([]byte, []int) {
	return file_agentassist_proto_rawDescGZIP(), []int{29, 0}
}
...
func (x *WorkReportRequest) GetSessionId() string {
	if x != nil {
		return x.SessionId
	}
	return ""
...
func (x *RequestCancelledNotification) GetReasonCode() string {
	if x != nil {
		return x.ReasonCode
	}
	return ""
...
type McpHeartbeatRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *McpHeartbeatRequest) Reset() {
	*x = McpHeartbeatRequest{}
	mi := &file_agentassist_proto_msgTypes[23]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *McpHeartbeatRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*McpHeartbeatRequest) ProtoMessage() {}

func (x *McpHeartbeatRequest) ProtoReflect() protoreflect.Message {
	mi := &file_agentassist_proto_msgTypes[23]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use McpHeartbeatRequest.ProtoReflect.Descriptor instead.
func (*McpHeartbeatRequest) Descriptor() ([]byte, []int) {
	return file_agentassist_proto_rawDescGZIP(), []int{23}
}

func (x *McpHeartbeatRequest) GetSessionId() string {
	if x != nil {
		return x.SessionId
	}
	return ""
...
func (x *McpHeartbeatRequest) GetUserToken() string {
	if x != nil {
		return x.UserToken
	}
	return ""
...
func (x *McpHeartbeatRequest) GetTimestamp() int64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
type McpHeartbeatResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Success       bool                   `protobuf:"varint,1,opt,name=Success,proto3" json:"Success,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *McpHeartbeatResponse) Reset() {
	*x = McpHeartbeatResponse{}
	mi := &file_agentassist_proto_msgTypes[24]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *McpHeartbeatResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*McpHeartbeatResponse) ProtoMessage() {}

func (x *McpHeartbeatResponse) ProtoReflect() protoreflect.Message {
	mi := &file_agentassist_proto_msgTypes[24]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use McpHeartbeatResponse.ProtoReflect.Descriptor instead.
func (*McpHeartbeatResponse) Descriptor() ([]byte, []int) {
	return file_agentassist_proto_rawDescGZIP(), []int{24}
}

func (x *McpHeartbeatResponse) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
func (x *UserConnectionStatusNotification) Reset() {
	*x = UserConnectionStatusNotification{}
	mi := &file_agentassist_proto_msgTypes[38]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UserConnectionStatusNotification) Descriptor() ([]byte, []int) {
	return file_agentassist_proto_rawDescGZIP(), []int{38}
}
...
func (x *WebsocketMessage) Reset() {
	*x = WebsocketMessage{}
	mi := &file_agentassist_proto_msgTypes[39]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*WebsocketMessage) Descriptor() ([]byte, []int) {
	return file_agentassist_proto_rawDescGZIP(), []int{39}
}
...
const file_agentassist_proto_rawDesc = "" +
	...
	"\tQuestions\x18\a \x03(\v2\x1a.agentassistproto.QuestionR\tQuestions\"\xc1\x01\n" +
	...
	"\tSessionId\x18\x05 \x01(\tR\tSessionId\"\xfd\x01\n" +
	...
	"\tAgentName\x18\x04 \x01(\tR\tAgentName\x12.\n" +
	"\x12ReasoningModelName\x18\x05 \x01(\tR\x12ReasoningModelName\x12$\n" +
	"\rMcpClientName\x18\x06 \x01(\tR\rMcpClientName\"\xbf\x01\n" +
	...
	"\tTimestamp\x18\x04 \x01(\x03R\tTimestamp\x12\x1c\n" +
	"\tSessionId\x18\x05 \x01(\tR\tSessionId\"\xfb\x01\n" +
	...
	"reasonCode\"o\n" +
	"\x13McpHeartbeatRequest\x12\x1c\n" +
	"\tSessionId\x18\x01 \x01(\tR\tSessionId\x12\x1c\n" +
	"\tUserToken\x18\x02 \x01(\tR\tUserToken\x12\x1c\n" +
	"\tTimestamp\x18\x03 \x01(\x03R\tTimestamp\"0\n" +
	"\x14McpHeartbeatResponse\x12\x18\n" +
	...
	"\bNickname\x18\x12 \x01(\tR\bNickname2\x87\x03\n" +
	...
	"\x11SendMcpClientInfo\x12&.agentassistproto.McpClientInfoRequest\x1a'.agentassistproto.McpClientInfoResponse\x12Z\n" +
	"\tHeartbeat\x12%.agentassistproto.McpHeartbeatRequest\x1a&.agentassistproto.McpHeartbeatResponseB}\n" +
	"/code.agentassistant.flutter.flutterclient.protoB\x10AgentAssistProtoP\x01Z6github.com/yangjuncode/agentassistant/agentassistprotob\x06proto3"
...
var file_agentassist_proto_msgTypes = make([]protoimpl.MessageInfo, 43)
var file_agentassist_proto_goTypes = []any{
	...
	(*McpHeartbeatRequest)(nil),              // 24: agentassistproto.McpHeartbeatRequest
	(*McpHeartbeatResponse)(nil),             // 25: agentassistproto.McpHeartbeatResponse
	(*OnlineUser)(nil),                       // 26: agentassistproto.OnlineUser
	(*GetOnlineUsersRequest)(nil),            // 27: agentassistproto.GetOnlineUsersRequest
	(*GetOnlineUsersResponse)(nil),           // 28: agentassistproto.GetOnlineUsersResponse
	(*ChatMessage)(nil),                      // 29: agentassistproto.ChatMessage
	(*ForwardTarget)(nil),                    // 30: agentassistproto.ForwardTarget
	(*ForwardWindowItem)(nil),                // 31: agentassistproto.ForwardWindowItem
	(*SendChatMessageRequest)(nil),           // 32: agentassistproto.SendChatMessageRequest
	(*ChatMessageNotification)(nil),          // 33: agentassistproto.ChatMessageNotification
	(*ForwardStateQueryRequest)(nil),         // 34: agentassistproto.ForwardStateQueryRequest
	(*ForwardStateQueryResponse)(nil),        // 35: agentassistproto.ForwardStateQueryResponse
	(*ForwardStateChangedNotification)(nil),  // 36: agentassistproto.ForwardStateChangedNotification
	(*ForwardDeliveryErrorNotification)(nil), // 37: agentassistproto.ForwardDeliveryErrorNotification
	(*UserLoginResponse)(nil),                // 38: agentassistproto.UserLoginResponse
	(*UserConnectionStatusNotification)(nil), // 39: agentassistproto.UserConnectionStatusNotification
	(*WebsocketMessage)(nil),                 // 40: agentassistproto.WebsocketMessage
	nil,                                      // 41: agentassistproto.AskQuestionResponse.MetaEntry
	nil,                                      // 42: agentassistproto.WorkReportResponse.MetaEntry
	nil,                                      // 43: agentassistproto.CheckMessageValidityResponse.ValidityEntry
}
var file_agentassist_proto_depIdxs = []int32{
	...
	41, // 7: agentassistproto.AskQuestionResponse.Meta:type_name -> agentassistproto.AskQuestionResponse.MetaEntry
	...
	42, // 10: agentassistproto.WorkReportResponse.Meta:type_name -> agentassistproto.WorkReportResponse.MetaEntry
	...
	43, // 13: agentassistproto.CheckMessageValidityResponse.validity:type_name -> agentassistproto.CheckMessageValidityResponse.ValidityEntry
	...
	26, // 17: agentassistproto.GetOnlineUsersResponse.online_users:type_name -> agentassistproto.OnlineUser
	30, // 18: agentassistproto.ChatMessage.forward_target:type_name -> agentassistproto.ForwardTarget
	0,  // 19: agentassistproto.ForwardTarget.mode:type_name -> agentassistproto.ForwardTarget.Mode
	30, // 20: agentassistproto.SendChatMessageRequest.forward_target:type_name -> agentassistproto.ForwardTarget
	29, // 21: agentassistproto.ChatMessageNotification.chat_message:type_name -> agentassistproto.ChatMessage
	31, // 22: agentassistproto.ForwardStateQueryResponse.windows:type_name -> agentassistproto.ForwardWindowItem
	31, // 23: agentassistproto.ForwardStateChangedNotification.windows:type_name -> agentassistproto.ForwardWindowItem
	26, // 24: agentassistproto.UserConnectionStatusNotification.user:type_name -> agentassistproto.OnlineUser
	...
	27, // 34: agentassistproto.WebsocketMessage.GetOnlineUsersRequest:type_name -> agentassistproto.GetOnlineUsersRequest
	28, // 35: agentassistproto.WebsocketMessage.GetOnlineUsersResponse:type_name -> agentassistproto.GetOnlineUsersResponse
	32, // 36: agentassistproto.WebsocketMessage.SendChatMessageRequest:type_name -> agentassistproto.SendChatMessageRequest
	33, // 37: agentassistproto.WebsocketMessage.ChatMessageNotification:type_name -> agentassistproto.ChatMessageNotification
	38, // 38: agentassistproto.WebsocketMessage.UserLoginResponse:type_name -> agentassistproto.UserLoginResponse
	39, // 39: agentassistproto.WebsocketMessage.UserConnectionStatusNotification:type_name -> agentassistproto.UserConnectionStatusNotification
	34, // 40: agentassistproto.WebsocketMessage.ForwardStateQueryRequest:type_name -> agentassistproto.ForwardStateQueryRequest
	35, // 41: agentassistproto.WebsocketMessage.ForwardStateQueryResponse:type_name -> agentassistproto.ForwardStateQueryResponse
	36, // 42: agentassistproto.WebsocketMessage.ForwardStateChangedNotification:type_name -> agentassistproto.ForwardStateChangedNotification
	37, // 43: agentassistproto.WebsocketMessage.ForwardDeliveryErrorNotification:type_name -> agentassistproto.ForwardDeliveryErrorNotification
	...
	24, // 47: agentassistproto.SrvAgentAssist.Heartbeat:input_type -> agentassistproto.McpHeartbeatRequest
	11, // 48: agentassistproto.SrvAgentAssist.AskQuestion:output_type -> agentassistproto.AskQuestionResponse
	14, // 49: agentassistproto.SrvAgentAssist.WorkReport:output_type -> agentassistproto.WorkReportResponse
	17, // 50: agentassistproto.SrvAgentAssist.SendMcpClientInfo:output_type -> agentassistproto.McpClientInfoResponse
	25, // 51: agentassistproto.SrvAgentAssist.Heartbeat:output_type -> agentassistproto.McpHeartbeatResponse
