...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Forward to System Input'**
  String get forwardConfirmTitle;

  /// No description provided for @forwardConfirmMessage.
  ///
  /// In en, this message translates to:
  /// **'The message is very long ({length} characters) and may take a long time to input. Do you want to proceed?'**
  ...
  /// No description provided for @initiatorDisconnected.
  ///
  /// In en, this message translates to:
  /// **'Initiator disconnected'**
  String get initiatorDisconnected;
  ...
  /// No description provided for @openAppSettingsDesc.
  ///
  /// In en, this message translates to:
